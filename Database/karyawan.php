...
<div class="main">
    ...
    <center>
        <form>
<html>
    <br><div class="judul"> Tabel karyawan</div></br>
    <table border="1">
        <tr>
            <th>Id Karyawan</th>
            <th>Nama Karyawan</th>
    ...
    <?php
        ...
        while ($tampil=mysqli_fetch_array($data)){
            ...
            <tr>
                ...
                <td><a href="hapus-karyawan.php?id=<?php echo $tampil ['id_karyawan']; ?>">Hapus</a>
                <a href="edit-karyawan.php?id=<?php echo $tampil ['id_karyawan']; ?>">Edit</a>
                </td>
            </tr>
    ...
    <br><div class="link"><a href="input-karyawan.php"> Tambahkan Data Baru </a></div></br>
</html>